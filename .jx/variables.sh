...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-project/main/30'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-project:0.2.85'
