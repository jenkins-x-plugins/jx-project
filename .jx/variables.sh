...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-project/HEAD/2'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-project:0.2.70'
