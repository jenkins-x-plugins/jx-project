...
require (
	...
	github.com/jenkins-x-plugins/jx-promote v0.0.260
	...
	github.com/jenkins-x/lighthouse-client v0.0.118
...
replace (
	...
	github.com/jenkins-x/go-scm => github.com/jenkins-x/go-scm v1.7.3
