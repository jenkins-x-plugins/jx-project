...
require (
	...
	github.com/jenkins-x-plugins/jx-promote v0.4.6
	github.com/jenkins-x/go-scm v1.13.10
	github.com/jenkins-x/jx-api/v4 v4.6.3
	github.com/jenkins-x/jx-helpers/v3 v3.4.9
	github.com/jenkins-x/jx-logging/v3 v3.0.11
	github.com/jenkins-x/lighthouse-client v0.0.770
...
require (
	...
	github.com/jenkins-x-plugins/jx-charter v0.0.28 // indirect
	github.com/jenkins-x/jx-kube-client/v3 v3.0.7 // indirect
