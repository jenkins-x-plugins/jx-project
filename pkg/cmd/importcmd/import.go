...
func (o *ImportOptions) AddImportFlags(cmd *cobra.Command, createProject bool) {
	...
	cmd.Flags().StringVar(&o.SchedulerName, "scheduler", "in-repo", "Change schedulerName, More info in https://jenkins-x.io/v3/develop/faq/config/repos/#how-do-i-customise-a-scheduler")
