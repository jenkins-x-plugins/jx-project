...
func (o *ImportOptions) ImportProjectIntoJenkins(jc gojenkins.JenkinsClient, gitURL, dir, jenkinsfile, branchPattern, credentials string, failIfExists bool, gitProvider gits.GitProvider, authConfigSvc auth.ConfigService, isEnvironment, batchMode bool) error {
	...
	// TODO - not sure what the credentials ID should be here...
...
func (o *ImportOptions) JenkinsClient() (gojenkins.JenkinsClient, error) {
	cf, err := factory.NewClientFactory()
	if err != nil {
		return nil, err
	}
...
func (o *ImportOptions) createJenkinsProject(opts *JenkinsProjectOptions, jc gojenkins.JenkinsClient,
...
func (o *ImportOptions) registerJenkinsWebhook(jc gojenkins.JenkinsClient, gitProvider gits.GitProvider,
...
func (o *ImportOptions) getBranchPattern(gitProvider gits.GitProvider, dir string) (string, error) {
...
func (o *ImportOptions) updateJenkinsCredentials(credentials string, jc gojenkins.JenkinsClient, gitProvider gits.GitProvider) (string, error) {
	if credentials == "" {
