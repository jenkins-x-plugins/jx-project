...
func CreateResolver(packsDir string, gitter gitclient.Interface) (jenkinsfile.ImportFileResolver, error) {
...
func Resolve(m *jenkinsfile.Module, gitter gitclient.Interface) (*ModuleResolver, error) {
	err := m.Validate()
	if err != nil {
		return nil, err
	}
...
func ResolveModules(m *jenkinsfile.Modules, gitter gitclient.Interface) (*ModulesResolver, error) {
